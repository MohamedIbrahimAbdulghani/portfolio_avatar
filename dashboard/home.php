  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
            ...
            <ul class="nav nav-treeview nav nav-pills nav-sidebar flex-column">
              <li class="nav-item">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="backassets/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="backassets/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="backassets/dist/img/user1-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="backassets/dist/img/user7-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="backassets/dist/img/user3-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="backassets/dist/img/user5-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="backassets/dist/img/user6-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="backassets/dist/img/user8-128x128.jpg" alt="User Avatar">
