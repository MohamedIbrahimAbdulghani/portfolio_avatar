<?php
session_start(); 
require_once "dashboard/lib/function.php";
...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <div class="row justify-content-center">
                    ...
                    <?php foreach($projects as $project): ?>
                        <div class="col-md-6 col-lg-4 mb-5">
                            <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#Model1">
                                <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                                    <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid" src="dashboard/upload_file/<?php echo $project["image"]; ?> " alt="..." />
        ...
        <!-- Portfolio Modals-->
        <!-- Portfolio Modal 1-->
            <div class="portfolio-modal modal fade" id="Model1" tabindex="-1" aria-labelledby="portfolioModal" aria-hidden="true">
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                        ...
                                        <img class="img-fluid rounded mb-5" src="dashboard/upload_file/<?php echo $project["image"] ?>" alt="..." />
